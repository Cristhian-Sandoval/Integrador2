        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-head-line">Lista de reserva de clientes</h1>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                        ...
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Fecha Reserva</th>   <!-- Celda de cabecera de la columna 3 -->
                                                    <th>Hora Reserva</th>
                                                    <th>Sala</th>
                                                    <th>Estado</th>                            
                                                    <th>Acciones</th>
                                    ...
                                    <!--<td><td>${reserva.isEstado()}</td>-->
                                                        <td>
                                                            <c:choose>  
                                                                <c:when test="${reserva.isEstado()}">
                                                                    Activo
                                                                </c:when>
                                                                <c:otherwise>
                                                                    Desactivo
                                                        ...
                                                        <td>            
                                                            <input type="hidden" name="id" id="id_cli" value="${reserva.getIdReserva()}">
                                                                <a href="#" class="edit" title="Editar" data-toggle="modal"><i class="fa fa-edit"></i></a>                     
                                                                <a href="#" data-href="# data-target="#deleteEmployeeModal" class="delete" title="Borrar" data-toggle="modal"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
            ...
            <div class="modal-dialog">
                <div class="modal-content">                                                  
                    ...
                    <div class="modal-body">
                        <p>Estas seguro que quieres eliminar esta reserva?</p>
