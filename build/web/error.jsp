    ...
    <div class="container">
         ...
         <div class="row text-center">
                ...
                <div class="col-md-12 set-pad" >
                           ...
                           <p class="p-err">ACCESO RESTRINGIDO</p>
                    <a href="index.jsp" class="btn btn-danger" ><i class="fa fa-mail-reply"></i>&nbsp;REGRESAR</a>
                        </div>
       ...
       <!-- <div class="row ">
            <div class="form-group input-group col-md-6 col-md-offset-3">
                ...
                <span class="input-group-btn">
                    <a class="btn btn-primary" href="www.google.com">
