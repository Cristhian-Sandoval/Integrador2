        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div id="page-inner">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-head-line">Lista de Salas</h1>
                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th>Descripción</th>   <!-- Celda de cabecera de la columna 1 -->
                                                    <th>Aforo</th>   <!-- Celda de cabecera de la columna 2 -->                          
                                                    <th>Acciones</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <c:forEach items="${lista}" var="salas" >
                                                    <tr>
                                                        <!--<td>${salas.getIdSala()}</td>-->
                                                        <td>${salas.getDescripcion()}</td>
                                                        <td>${salas.getAforo()}</td>  


                                    <!--<td><td>${salas.isEstado()}</td>-->
                                                        <td>
                                                            <c:choose>  
                                                                <c:when test="${salas.isEstado()}">
                                                                    Activo
                                                                </c:when>
                                                                <c:otherwise>
                                                                    Desactivo
                                                        ...
                                                        <td>            
                                                            <input type="hidden" name="id" id="id_cli" value="${salas.getIdSala()}">
                                                                <a href="#editClienteModal" class="edit" title="Editar" data-toggle="modal"><i class="fa fa-edit"></i></a>                     
                                                                <a href="#" data-href="salacontroller.do?txtProceso=borrar&id=<c:out value='${salas.idSala}'/>" data-target="#deleteEmployeeModal" class="delete" title="Borrar" data-toggle="modal"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
            ...
            <div class="modal-dialog">
                <div class="modal-content">                                                  
                    ...
                    <div class="modal-body">
                        <p>Estas seguro que quieres eliminar esta sala?</p>
                                ...
                                <input type="hidden" name="txtProceso" value="editar">
                                    ...
                                    <div class="modal-body">					
                                        <div class="form-group">
                                            ...
                                            <input id="descripcion" name="descripcion" type="text" class="form-control" pattern="[A-Za-z ]+" required>
                                        </div>
                                        <div class="form-group">
                                            <label>Aforo</label>
                                                ...
                                                <script type="text/javascript">
                                                    $(document).ready(function () {
                                                        ...
                                                        $('table .edit').on('click', function () {
                                                            ...
                                                            $.ajax({
                                                                type: 'GET',
                                                                url: "salacontroller.do?txtProceso=mostrarID",
                                                                data: {id: id},
                                                                success: function (result) {
                                                                    ...
                                                                    $('#editClienteModal #descripcion').val(result.descripcion);
                                                                    $('#editClienteModal #aforo').val(result.aforo);
